...
Listado.prototype.obtenerUbicaciones = function () {
    ...
    var arregloUbicaciones = this.restaurantes.map(function (restaurant) {
        return restaurant.ubicacion;
    });

    return sinRepetir(arregloUbicaciones);
...
Listado.prototype.obtenerRubros = function () {
    var arregloRubros = this.restaurantes.map(function (restaurant) {
        return restaurant.rubro;
    });

    return sinRepetir(arregloRubros);
...
Listado.prototype.obtenerHorarios = function () {
    ...
    arregloHorarios.forEach(function (a) {
        a.forEach(function (hor) {
            arregloElementos.push(hor)
        });
    });
    return sinRepetir(arregloElementos);

}


function sinRepetir(array) {
    var elementosFiltrados = array.filter(function (elem, index, self) {
        return index === self.indexOf(elem);
    });

    return elementosFiltrados.sort();
}
